...
assert.ok(sample.schema.includes("avgOnlineDuration7d"), "司机直达索引缺少近7天日均在线时长");
assert.equal(sample.schema.includes("avgServiceDuration7d"), false);
assert.equal(sample.schema.includes("serviceDurationSampleDays"), false);
